...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.homepage         = 'https://github.com/taoyeming/IQKeyboardManager.git'
    # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { '陶冶明' => 'taoyeming.tym@alibaba-inc.com' }
    s.source           = { :git => 'https://github.com/taoyeming/IQKeyboardManager.git', :tag => s.version.to_s }
    # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'
  
    s.ios.deployment_target = '9.0'
  
    s.vendored_libraries = "IQKeyboardManager/Classes/**/*.a"
  end